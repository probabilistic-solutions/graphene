...
- `lib/graphene/internal/core_components.ex`, `lib/graphene/internal/form_components.ex`, `lib/graphene/carbon_components.ex` are generated; update `lib/graphene/codegen/component_patch.ex` and re-run `mix graphene.core_components.generate` instead of editing it directly.
