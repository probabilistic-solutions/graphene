defmodule Graphene.ProductComponents.Tearsheet do
  @moduledoc """
  ...
  * `c4p-tearsheet-closed` - The custom event fired after this tearsheet is closed upon a user gesture.
  ...
  slot :description, doc: "Tearsheet description slot."
  slot :header_actions, doc: "Header action buttons slot."
  slot :header_navigation, doc: "Header navigation slot."
  slot :decorator, doc: "Decorator slot."
  slot :slug, doc: "Slug slot."
  slot :influencer, doc: "Influencer content slot."
  slot :actions, doc: "Footer actions slot."
  slot :inner_block

  def tearsheet(assigns) do
    ProductCoreComponents.tearsheet(assigns)
  end
end
