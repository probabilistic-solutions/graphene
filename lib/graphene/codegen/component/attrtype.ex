defmodule Graphene.CodeGen.Component.AttrType do
  ...
  def new(name) do
    new_with_values(name, Graphene.CodeGen.Metadata.type_values())
  end

  def new_with_values(name, type_values) do
    ...
    undefined? = String.contains?(name, "undefined") or String.contains?(name, "null")
    inline_values = extract_string_literals(name)

    info =
      case {cleanname, inline_values} do
        {_cleanname, values} when is_list(values) and values != [] ->
