defmodule Storybook.CarbonComponents.UIShell.Variants.Helpers do
  @moduledoc false

  use Phoenix.Component

  def story_content(assigns) do
    assigns = assign_new(assigns, :responsive_offset, fn -> true end)

    ~H"""
    <main class="cds--content cds-ce-demo-devenv--ui-shell-content">
      <div class="cds--grid">
        <div class="cds--row">
          <div class={["cds--col-lg-13", @responsive_offset && "cds--offset-lg-3"]}>
