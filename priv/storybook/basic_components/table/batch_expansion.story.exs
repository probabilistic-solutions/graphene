...
defmodule Storybook.BasicComponents.Table.BatchExpansion do
  ...
  def doc do
    "Table with batch expansion controls."
  end
  ...
  def render(assigns) do
    ...
    >
      ...
      <:description>With batch expansion</:description>
