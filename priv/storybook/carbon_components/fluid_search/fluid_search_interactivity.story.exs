defmodule Storybook.CarbonComponents.FluidSearch.Interactivity do
  ...
  def doc do
    """
    Interactive fluid search with input events wired.
  ...
  @impl true
  def handle_event("fluid_search:event", payload, socket) do
  ...
  defp fluid_search_events do
    [
      {"cds-search-input",
       [push: "fluid_search:event", payload: event_payload("cds-search-input")]}
    ]
  end
