...
defmodule Storybook.CarbonComponents.ProgressIndicator.Interactivity do
  ...
  def doc do
    "Progress indicator interactivity."
  end
  ...
  def render(assigns) do
    assigns = assign(assigns, :event_attrs, custom_event_attrs(["change", "onChange"]))

    ~H"""
    <.progress_indicator
      id="progress-indicator-events"
      current_index="1"
      {@event_attrs}
    >
