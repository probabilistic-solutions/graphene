defmodule Storybook.CarbonComponents.TimePicker.Interactivity do
  ...
  def doc do
    """
    Interactive time picker with change/invalid events wired.
  ...
  @impl true
  def handle_event("time_picker:event", payload, socket) do
  ...
  defp time_picker_events do
    [
      {"change", [push: "time_picker:event", payload: event_payload("change")]},
      {"invalid", [push: "time_picker:event", payload: event_payload("invalid")]}
    ]
  end
