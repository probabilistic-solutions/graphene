defmodule Storybook.CarbonComponents.Search.Interactivity do
  ...
  def doc do
    """
    Interactive search with input events wired.
    Use it to validate search payloads.
    """
  end
  ...
  @impl true
  def handle_event("search:event", payload, socket) do
  ...
  defp search_events do
    [
      {"cds-search-input", [push: "search:event", payload: event_payload("cds-search-input")]}
    ]
  end
