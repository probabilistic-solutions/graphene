...
defmodule Storybook.CarbonComponents.InlineLoading.Interactivity do
  ...
  def render(assigns) do
    assigns = assign(assigns, :event_attrs, custom_event_attrs(["cds-inline-loading-onsuccess"]))

    ~H"""
    <.inline_loading
      id="inline-loading-events"
      status="finished"
      {@event_attrs}
    />
