...
// node_modules/@carbon/web-components/es/globals/controllers/floating-controller.js
var FloatingController = class {
  ...
  async computePlacement() {
    ...
    const offsetPx = !isTabTip ? (_a = toPx(cs.getPropertyValue("--cds-popover-offset").trim())) !== null && _a !== void 0 ? _a : 10 : 0;
    const middleware = [
      offset2(caret && !isTabTip ? { alignmentAxis: alignmentAxisOffset, mainAxis: offsetPx } : 0),
      flip2({
        fallbackPlacements: isTabTip ? shimmedAlign.includes("bottom") ? ["bottom-start", "bottom-end", "top-start", "top-end"] : ["top-start", "top-end", "bottom-start", "bottom-end"] : isListBox || isMenu ? ["top", "bottom"] : shimmedAlign.includes("bottom") ? [
          "bottom",
          "bottom-start",
          "bottom-end",
          "right",
      ...
      ...caret && arrowElement ? [arrow2({ element: arrowElement, padding: 15 })] : [],
      ...[hide2()]
    ];
    if (open) {
      const { x, y, placement, middlewareData, strategy } = await computePosition2(trigger, element, {
        strategy: "fixed",
        middleware,
      ...
      element.style.visibility = ((_b = middlewareData.hide) === null || _b === void 0 ? void 0 : _b.referenceHidden) ? "hidden" : "visible";
      if (arrowElement) {
      ...
      if (this.host.tagName === "CDS-AI-LABEL" || this.host.tagName === "CDS-SLUG") {
