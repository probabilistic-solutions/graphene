...
// node_modules/@carbon/web-components/es/components/time-picker/time-picker.scss.js
...
// node_modules/@carbon/web-components/es/components/time-picker/defs.js
var TIME_PICKER_SIZE;
(function(TIME_PICKER_SIZE2) {
  TIME_PICKER_SIZE2["SMALL"] = "sm";
  TIME_PICKER_SIZE2["MEDIUM"] = "md";
  TIME_PICKER_SIZE2["LARGE"] = "lg";
})(TIME_PICKER_SIZE || (TIME_PICKER_SIZE = {}));

// node_modules/@carbon/web-components/es/components/time-picker/time-picker.js
var CDSTimePicker = class CDSTimePicker2 extends ValidityMixin(FormMixin(i2)) {
  constructor() {
    super(...arguments);
    this._value = "";
    this.disabled = false;
  ...
  render() {
    ...
    const timePickerClasses = e2(Object.assign({ [`${prefix}--time-picker`]: true, [`${prefix}--time-picker--invalid`]: normalizedProps.invalid, [`${prefix}--time-picker--warning`]: normalizedProps.warn, [`${prefix}--time-picker--readonly`]: readOnly, [`${prefix}--time-picker--${size}`]: size }, className && { [className]: true }));
    const inputClasses = e2(Object.assign({ [`${prefix}--time-picker__input-field`]: true, [`${prefix}--text-input`]: true, [`${prefix}--time-picker__input-field-error`]: normalizedProps.invalid || normalizedProps.warn }, className && { [className]: true }));
    const label = labelText ? b`<label class="${labelClasses}">${labelText}</label>` : null;
    return b`
        ...
        <div class="${timePickerClasses}">
          <div class="${prefix}--time-picker__input">
            <input
              ...
              .value="${value}"
              @input="${handleInput}" />
            ${normalizedProps.invalid || normalizedProps.warn ? b`
                  <div class="${prefix}--time-picker__error__icon">
                    ${normalizedProps.invalid ? iconLoader(_16, {
...
CDSTimePicker.shadowRootOptions = Object.assign(Object.assign({}, i2.shadowRootOptions), { delegatesFocus: true });
...
__decorate([
  n({ type: Number, attribute: "max-length", reflect: true })
...
var CDSTimePickerSelect = class CDSTimePickerSelect2 extends FormMixin(i2) {
  constructor() {
    super(...arguments);
...
CDSTimePickerSelect.shadowRootOptions = Object.assign(Object.assign({}, i2.shadowRootOptions), { delegatesFocus: true });
